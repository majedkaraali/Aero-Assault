...
# a7_left_2=pygame.image.load('src/img/a7_2-left.png')
# a7_rigt_2=pygame.image.load('src/img/a7_2-right.png')
...
# j20_left2=pygame.image.load('src/img/j20_2-left.png')
# j20_right2=pygame.image.load('src/img/j20_2-right.png')
...
# su25_left2=pygame.image.load('src/img/su25_2-left.png')
# su25_right2=pygame.image.load('src/img/su25_2-right.png')
# su25_left3=pygame.image.load('src/img/su25_3-left.png')
# su25_right3=pygame.image.load('src/img/su25_3-right.png')

# su27_left=pygame.image.load('src/img/su27-left.png')
# su27_right=pygame.image.load('src/img/su27-right.png')
# su27_left2=pygame.image.load('src/img/su27_2-left.png')
# su27_right2=pygame.image.load('src/img/su27_2-right.png')
