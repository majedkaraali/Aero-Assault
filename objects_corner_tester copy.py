...
#    print(angle)
    ...
    if angle <45:
        mid_pos='bottomleft'
        corner_pos=(rotated_rect.bottomleft[0],rotated_rect.bottomleft[1])
        custum_angel=angle
   

    elif angle < 90:
        mid_pos='midbottom'
        corner_pos=(rotated_rect.midbottom[0],rotated_rect.midbottom[1])
        custum_angel=angle+20
   

    elif angle<135:
        corner_pos=(rotated_rect.bottomright[0],rotated_rect.bottomright[1])
        mid_pos='bottomright'
        custum_angel=angle
   

    elif angle < 180:
        corner_pos=(rotated_rect.midright[0],rotated_rect.midright[1])
        custum_angel=angle+20
        mid_pos='midright'
        ...
        mid_pos='topright'
        corner_pos=(rotated_rect.topright[0],rotated_rect.topright[1])
        custum_angel=angle
   

    elif angle < 270:
        corner_pos=(rotated_rect.midtop[0],rotated_rect.midtop[1])
        custum_angel=angle+20
        mid_pos='midtop'
        ...
        mid_pos='topleft'
        corner_pos=(rotated_rect.topleft[0],rotated_rect.topleft[1])
        custum_angel=angle
   

    elif angle <360:
        corner_pos=(rotated_rect.midleft[0],rotated_rect.midleft[1])
        custum_angel=angle+20
        mid_pos='midleft'
    ...
    screen.blit(rotated_image, rotated_rect.topleft)
    sprite.set_corners(tpleft,topright,bottomleft,bottomright,midleft,midright,midtop,midbottom)
    sprite.set_vars(2,2,custum_angel)
    sprite.update()
    sprite.draw(screen,'default',corner_pos)
